...
function player:checksides(dt)
    if self.x + self.xvel*dt >= love.graphics.getWidth()/2 - 10 then -- DIVIDE BY 2 BC WE SCALED EVERTHING UP BY 2 EARLIER, SO THE MAP IS RLLY 640 PX, NOT 1280
        print("ghadh")
    ...
    if self.x > love.graphics.getWidth()/2 then
        self.x = love.graphics.getWidth()/2 - 5
